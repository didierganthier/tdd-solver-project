...
# 📖 TDD Solving Project <a name="about-project"></a>


**TDD solving project** apply the knowledege of using the Test-Driven Development Metodology in ruby Language
...
```sh
  cd my-folder
  https://github.com/didierganthier/tdd-solver-project
```
...
Feel free to check the [issues page](https://github.com/didierganthier/tdd-solver-project/issues).
